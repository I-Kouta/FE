...
---
22.DBのアクセス効率を低下させないために、定期的に実施する処理
...
- ディスク障害からDBを回復するため、DBの内容をディスク単位で複写したものである\
バックアップの説明
...
- A.**クライアントのアプリケーションプログラムは、複数のサーバ上のDBをアクセスする。アプリケーションプログラムは、DBがあたかも1つのサーバ上で稼働しているかのようにアクセスできる**\
